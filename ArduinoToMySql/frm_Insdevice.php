<html>
    ...
    <body>
        ...
        <div class="row">
            ...
            <div class="col-lg-4">
              <form action="insert_device.php" method="post">
                <div class="mb-3">
                  <label for="id_device" class="form-label">ID DEVICE</label>
                  <input type="text" class="form-control" id="id_device"  name="id_device" required>
                </div>
                <div class="mb-3">
                  <label for="name_device" class="form-label">NAME DEVICE</label>
                  <input type="text" class="form-control" id="name_device" name="name_device" required>
                </div>
